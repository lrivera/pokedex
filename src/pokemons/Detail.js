...
type PropsType = {
  ...OwnProps,
  pokemons: {},
  getPokemonsById:(pokemonID:string)=>any,
}
const Detail = (props:PropsType) => {
    const {getPokemonsById, pokemons={}} = props
    const { pokemonId="" }:{pokemonId:?string} = useParams();
...
const mapDispatchToProps = dispatch => ({
  ...
  let DetailContainer = connect<PropsType, OwnProps, _, _, _, _>(
    mapStateToProps,
    mapDispatchToProps
  )(Detail)
